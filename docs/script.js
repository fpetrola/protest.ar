                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:flex flex-1 max-w-lg mx-8">
                        <div class="relative w-full">
                            <input
                                type="text"
                                placeholder="Buscar reclamos, entidades..."
        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Expresa tu reclamo y ayuda a promover la transparencia ciudadana
                </p>
            </div>
    ...
    return `
        <div>
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Explora reclamos ciudadanos con datos públicos conectados
                </p>
            </div>
    ...
    return `
        <div class="max-w-6xl mx-auto">
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    Visualiza tendencias y conexiones de datos en tiempo real
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="text-sm text-gray-600 mt-2">Problemas Detectados</div>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                ...
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-4xl mx-auto">
                        ...
                        <p class="text-xl mb-8 opacity-90">
                            Conectamos tus reclamos con datos públicos para 
                        ...
                        <div class="sticky top-4 space-y-6">
                            <div class="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Problemas Detectados</span>
